...
import { FaQuestionCircle, FaChevronLeft, FaChevronRight } from "react-icons/fa"; // Added chevrons
  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center h-20 px-6 ${collapsed ? "justify-center" : ""}`}>
        ...
        >
          <h2 className="text-sm font-bold text-gray-800 dark:text-white whitespace-nowrap">
            KiranaFinTech
          </h2>
