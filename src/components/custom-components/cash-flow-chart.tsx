      ...
      <CardContent>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-slate-700 grid grid-cols-3 gap-4 text-center text-sm">
          <div>
            ...
            <div className="font-bold text-gray-700 dark:text-gray-200">${opening}</div>
          </div>
          <div>
            <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">Net Change</div>
            <div className="font-bold text-green-700 dark:text-green-400">${netChange}</div>
          </div>
          <div>
            <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">
              Closing Balance
            </div>
            <div className="font-bold text-gray-900 dark:text-gray-100">${closing}</div>
          </div>
        </div>
      </CardContent>
      </Card>
